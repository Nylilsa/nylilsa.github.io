...
[img=guides/th10-extra-rta/prebomb.png, figtitle=Top health bar: a prebomb was used. Bottom health bar: No prebomb was used., alt=Two healthbars are shown that have different values.]
...
[img=guides/th10-extra-rta/s3.png, figtitle=MarisaB being slightly above Suwako on her third spell-card, misdirecting her first wave, alt=A screenshot of MarisaB being above Suwako.]
...
[img=guides/th10-extra-rta/normal-alignment.png, figtitle=Left: MarisaB is not aligned (2 lasers hit). Right: MarisaB is aligned (3 lasers hit), alt=Two images of MarisaB next to each other., other=max-height: 400px;]
