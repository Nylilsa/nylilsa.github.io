...
[img=guides/th15-pristine-lunacy/breakdown1.png, figtitle=Part one: The initial blast where the lasers spawn and pan out. Notice how the laser is forming an S shape around Reimu. Keep in mind that the lasers have a random initial rotation to them., alt=The lasers of Pristine Lunacy are approaching Reimu, other=max-height:360px]

[img=guides/th15-pristine-lunacy/breakdown2.png, figtitle=Part two: The second part, which I’m going to call the loop around, where the lasers come from off screen below you., alt=The lasers of Pristine Lunacy are approaching Reimu from behind., other=max-height:360px]

[img=guides/th15-pristine-lunacy/breakdown3.png, figtitle=Part three: And the final part, which I will call followthrough, where the lasers once again loop and come back. This part overlaps with the next wave which is why people have so much trouble with this spell., alt=The second wave of lasers is approaching Reimu., other=max-height:360px]
...
[img=guides/th15-pristine-lunacy/looparound1.png, figtitle=As you can see, the laser coming from below comes slightly to the side of where it ends. Over at the bottom left corner you can see how the laser loops offscreen., alt=Image demonstrated where to sit at to avoid lasers on first wave., other=max-height:360px]
...
[img=guides/th15-pristine-lunacy/followthrough1.png, figtitle=As you can see, I have not moved from my spot and the lasers pretty much put Reimu centered of the gap., alt=A continuation visualization from the previous figure, which also shows where to sit at to avoid lasers., other=max-height:360px]
...
For the method I use, I keep my eyes locked to right in front of Junko.

[img=guides/th15-pristine-lunacy/readingtheoverlaps1.png, figtitle=This area (the blue circle) is where you want to read., alt=Figure shows a blue circle pointing wher to read the pattern at., other=max-height:360px]

I look at the gaps that form between the lasers and use those to judge where the safe areas are going to be. 

[img=guides/th15-pristine-lunacy/readingtheoverlaps2.png, figtitle=In this example I have 2 potential gaps that I can choose. Both of these will work but one is significantly easier to reach. Once again you have to keep the wave in mind as the red initial blast will put a laser to your left instead., alt=Image shows two possible paths for dodging upcoming wave., other=max-height:360px]
...
So what do we do if the only gap that can work is further to the side, such as below? Quite simple actually:

[img=guides/th15-pristine-lunacy/readingtheoverlaps3.png, figtitle=If you feel as if you aren’t able to move to the left or right to easily avoid a wave then you’ll have to take the somewhat scarier option of moving up through the laser lane you’re in. You have to press up and either the left or right at basically the same time. You have to be careful as you’ll move up at an angle steeper than the laser lane so if you go too much you’ll hit the top laser. It takes some getting used to for sure., alt=Image shows a tricky situation where the lasers are being annoying to deal with., other=max-height:360px]
...
[img=guides/th15-pristine-lunacy/otherreadingmethods1.png, figtitle=This method looks at where the laser is going., alt=Some strokes are drawn on the lasers of Pristine Lunacy, other=max-height:360px]

Another method is the look at where the lasers are looping around closest to you.

[img=guides/th15-pristine-lunacy/otherreadingmethods2.png, figtitle=This method looks at where the lasers are looping around closest to you., alt=A line is drawn from Junko to Reimu, other=max-height:360px]
...
[img=guides/th15-pristine-lunacy/otherreadingmethods3.png, figtitle=This method looks at gaps in wave above to determine gap, alt=A line is drawn from the gap to Reimu, other=max-height:360px]
