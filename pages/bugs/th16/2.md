...
* **Shottype**: [yes]ReimuSpring[/yes] - [yes]CirnoSpring[/yes] - [yes]AyaSpring[/yes] - [yes]MarisaSpring[/yes] - [yes]ReimuSummer[/yes] - [yes]CirnoSummer[/yes] - [yes]AyaSummer[/yes] - [yes]MarisaSummer[/yes] - [yes]ReimuAutumn[/yes] - [yes]CirnoAutumn[/yes] - [yes]AyaAutumn[/yes] - [yes]MarisaAutumn[/yes] - [yes]ReimuWinter[/yes] - [yes]CirnoWinter[/yes] - [yes]AyaWinter[/yes] - [yes]MarisaWinter[/yes] - [no]ReimuExtra[/no] - [no]CirnoExtra[/no] - [no]AyaExtra[/no] - [no]MarisaExtra[/no]
...
[img=bugs/th16/2_spam.png, figtitle=Left: Stage 3 post-mid-boss section with a lot of bullets. Right: Stage 5 pre-mid-boss section with a lot of lasers., alt=Stage 3 and Stage 5 sections are shown, in particular parts with lots of bullets/lasers]
