...
* **Versions**: [yes]1.00a[/yes] - [yes]1.01a[/yes] - [yes]1.01b[/yes] - [yes]1.01c[/yes] - [yes]1.02a[/yes]
* **Shottype**: [yes]Aya[/yes]
* **Scenes**: Any
...
1. The crash happens on saving a replay (offset: tobedone)
...
[code]void FormatReplayString(char *buffer)
{
    __time32_t t;
    struct tm *tm_info;
