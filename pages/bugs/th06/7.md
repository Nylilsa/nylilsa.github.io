[title=Remilia's 2nd non-spell timer]
...
Internally, the game increases a variable called [ins=2, n=10022] until it hits 2700 frames. To be more specific, it checks for the following condition: ``[ins=2, n=10022] >= 2700``. [ins=2, n=10022] automatically increments by one every in-game frame. However, there is a second way in which [ins=2, n=10022]'s value can be changed. On Remilia's 2nd non-spell, we have the following code exists:
