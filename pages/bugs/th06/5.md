...
Use a bomb right as an enemy is about to appear from off-screen. This more notably happens when the [hl2]screen-shaking effect is extremely violent[/hl2], which is with the shottypes ReimuB and MarisaA.
