[title=Merlin, Lyrica & Lunasa Glitch]  
...
<ol class='toc'>
Table of contents
        <li>[jumpto=#whathappens][what][/jumpto]</li>
        <li>[jumpto=#howithappens][how][/jumpto]
                <ol>
                        <li>[jumpto=#merlinssetup]Merlin's set-up[/jumpto]
                                <ol>
                                        <li>[jumpto=#merlinssubroutinesnonspell2]Merlin's subroutines - non-spell 2[/jumpto]</li>
                                        <li>[jumpto=#merlinssubroutinesspell1]Merlin's subroutines - spell 1[/jumpto]</li>
                                        <li>[jumpto=#merlinssubroutinesnonspell3]Merlin's subroutines - non-spell 3[/jumpto]</li>
                                        <li>[jumpto=#merlinssubroutinesspell2]Merlin's subroutines - spell 2[/jumpto]</li>
                                        <li>[jumpto=#merlinsfullcallstackfinalspellcardglitch]Merlin's full call stack - Final spell-card glitch[/jumpto]</li>
                                        <li>[jumpto=#merlinscallstackpostbossglitch]Merlin's call stack - Post-boss glitch[/jumpto]</li>
                                </ol>
                        </li>
                        <li>[jumpto=#lyricassetup]Lyrica's set-up[/jumpto]
                                <ol>
                                        <li>[jumpto=#lyricassubroutinesnonspell1]Lyrica's subroutines - non-spell 1[/jumpto]</li>
                                        <li>[jumpto=#lyricassubroutinesnonspell2]Lyrica's subroutines - non-spell 2[/jumpto]</li>
                                        <li>[jumpto=#lyricassubroutinesspell1]Lyrica's subroutines - spell 1[/jumpto]</li>
                                        <li>[jumpto=#lyricassubroutinesnonspell3]Lyrica's subroutines - non-spell 3[/jumpto]</li>
                                        <li>[jumpto=#lyricassubroutinesspell2]Lyrica's subroutines - spell 2[/jumpto]</li>
                                        <li>[jumpto=#lyricasfullcallstackpostbossglitch]Lyrica's full call stack - Post-boss glitch[/jumpto]</li>
                                </ol>
                        </li>
                        <li>[jumpto=#lunasassetup]Lunasa's set-up[/jumpto]
                                <ol>
                                        <li>[jumpto=#lunasassubroutinesnonspell1]Lunasa's subroutines - non-spell 1[/jumpto]</li>
                                        <li>[jumpto=#lunasassubroutinesnonspell2]Lunasa's subroutines - non-spell 2[/jumpto]</li>
                                        <li>[jumpto=#lunasassubroutinesspell1]Lunasa's subroutines - spell 1[/jumpto]</li>
                                        <li>[jumpto=#lunasassubroutinesnonspell3]Lunasa's subroutines - non-spell 3[/jumpto]</li>
                                        <li>[jumpto=#lunasasfullcallstackpostbossglitch]Lunasa's full call stack - Post-boss glitch[/jumpto]</li>
                                </ol>
                        </li>
                </ol>
        </li> 
        <li>[jumpto=#whyithappens][why][/jumpto]
                <ol>
                        <li>[jumpto=#whatisthestack]What is the stack?[/jumpto]</li>
                        <li>[jumpto=#thestacklimit]The stack limit[/jumpto]</li>
                        <li>[jumpto=#stackoverflow]Stack overflow[/jumpto]
                                <ol>
                                        <li>[jumpto=#stackoverflowmerlinsfinalspellcardglitch]Stack overflow - Merlin's final spell-card glitch[/jumpto]
                                                <ol>
                                                        <li>[jumpto=#merlinsfinalspellcardglitchmerlindoesnotdespawn]Merlin's final spell-card glitch - Merlin does not despawn[/jumpto]</li>
                                                </ol>
                                        </li>
                                        <li>[jumpto=#stackoverflowmerlinspostbossglitch]Stack overflow - Merlin's post-boss glitch[/jumpto]
                                                <ol>
                                                        <li>[jumpto=#merlinspostbossglitchcircularmotion]Merlin's post-boss glitch - Circular motion[/jumpto]</li>
                                                </ol>
                                        </li>
                                        <li>[jumpto=#stackoverflowlyricaspostbossglitch]Stack overflow - Lyrica's post-boss glitch[/jumpto]
                                                <ol>
                                                        <li>[jumpto=#lyricaspostbossglitchcircularmotion]Lyrica's post-boss glitch - Circular motion[/jumpto]</li>
                                                </ol>
                                        </li>
                                        <li>[jumpto=#stackoverflowlunasaspostbossglitch]Stack overflow - Lunasa's post-boss glitch[/jumpto]
                                                <ol>
                                                        <li>[jumpto=#lunasaspostbossglitchcircularmotion]Lunasa's post-boss glitch - Circular motion[/jumpto]</li>
                                                </ol>
                                        </li>
                                </ol>
                        </li>
                        <li>[jumpto=#stackoverflowonotherbosses]Stack overflow on other bosses?[/jumpto]</li>
                </ol>
        </li>
        <li>[jumpto=#allprobabilities]All probabilities[/jumpto]
                <ol>
                        <li>[jumpto=#merlinsprobabilities]Merlin's probabilities[/jumpto]</li>
                        <li>[jumpto=#lyricasprobabilities]Lyrica's probabilities[/jumpto]</li>
                        <li>[jumpto=#lunasasprobabilities]Lunasa's probabilities[/jumpto]</li>
                </ol>
        </li>
        <li>[jumpto=#conclusion]Conclusion[/jumpto]</li>
        <li>[jumpto=#links][links][/jumpto]
            <ol>
                <li>[jumpto=#replays][rpy][/jumpto]</li>
                <li>[jumpto=#videos][vid][/jumpto]</li>
                <li>[jumpto=#other][misc][/jumpto]</li>
            </ol>
        </li>
</ol>
...
[img=bugs/th07/0_merlin.png, figtitle=Two instances in which Merlin glitches out on the final spell-card., alt=Two images of Merlin glitching out]
...
This glitch is extraordinarily rare. [hl2]All current replays/videos[/hl2] related to the Merlin glitch that were uploaded before this page was published can be found in the [jumpto=#links]Links[/jumpto] section of this page.

[img=bugs/th07/0_lyrica_lunasa.png, figtitle=Lyrica and Lunasa both glitch out after the final spell-card, alt=Two images of Lunasa and Lyrica glitching out]

Though, [hl2]as of 2022-08-30, it has been found out that a Lyrica & Lunasa glitch exists[/hl2].
...
Note: The precisely-timed kills thing only works on the Prismriver sisters ! It does not work on other PCB bosses. The reason is explained [jumpto=#stackoverflowonotherbosses]here[/jumpto].
...
[box=1000] sub71 → sub72 → sub73 → sub76 → sub80 → sub81 → sub2 → sub121 → sub124 → sub83 → sub84 → sub2 → sub138 → sub2 → sub141/sub142 → sub143 → [hl2]sub2[/hl2][/box]
...
[box=1000] sub71 → sub72 → sub73 → sub76 → sub80 → [hl2]sub81[/hl2] → sub2 → sub121 → [hl2]sub124[/hl2] → sub83 → sub84 → [hl2]sub2[/hl2] → sub138 → [hl2]sub2[/hl2] → sub141/sub142 → sub143 → sub52[/box]
...
The [hl2]post-boss Merlin glitch[/hl2] takes place when [hl2]the last subroutine ``sub52`` in the full call stack is called[/hl2]

This has a very small probability of taking place. In essence, the following requirements must be met:
1. The player has to play as [hl2]Sakuya[/hl2].
2. The player has to [hl2]target Merlin[/hl2] during the 1st spell-card.
3. [hl2]On Easy/Normal, the probability of triggering this glitch is ``1/44``. On Hard/Lunatic, the probability of triggering this glitch is ``1/48``.[/hl2]
...
[hl2]The Lyrica glitch takes place when the last subroutine ``sub52`` is called[/hl2].
...
This means on average for a random player to replicate the Lyrica glitch, on Easy/Normal it would take them [hl2]45,103 attempts[/hl2], and on Hard/Lunatic it would take them [hl2]54,307 attempts[/hl2].
...
[hl2]The Lunasa glitch takes place when the last subroutine ``sub52`` is called[/hl2].
...
[img=bugs/th07/0_stack1.png, figtitle=A visualisation of the aforementioned example stack., alt=A diagram of the stack]
...
[img=bugs/th07/0_stack2.png, figtitle=An example visualisation of the stack when there is stack overflow, alt=A diagram of the stack with stack overflow]

### Stack overflow
[hr_minor]

[hl2]The next two sections talk in extensive detail[/hl2] about why some sisters do weird things. The subsequent sections talk in slightly less detail.
...
[hl2]Since ``sub143`` is not pushed to the stack, it means that any subroutines following ``sub143`` return to the 15th slot[/hl2] once those subroutines [hl2]return[/hl2]. In this case, the glitch happens once the last ``sub2`` returns. [hl2]This causes Merlin to return to ``sub141/sub142``, which is the Prismrivers' 3rd spell-card[/hl2].

[img=bugs/th07/0_stack3.png, figtitle=A visualisation of stack overflow on Merlin's call stack, alt=A diagram of the stack of Merlin with stack overflow.]

However, occasionally Merlin would survive and keep attacking post-boss. This can be seen in [a=https://www.youtube.com/watch?v=CU2Z6VobIvc&t=53s]the video[/a] of simugung. 

On top of the final spell-card Merlin glitch, [hl2]there is a chance where Merlin does not first move to the middle of the screen[/hl2], but instead where Merlin keeps attacking as if nothing has happened. For this to happen, its probability is ``12/1172``, which requires for ``sub52`` and ``sub144`` to be called for on the same frame. Its concept is explained in more detail in the next section.
...
[code]void sub141() { // Merlin's 3rd spell-card - Easy/Normal
    [...]
    loop {
        [...]
+130: // lasts for 130f
...
[code]void sub142() { // Merlin's 3rd spell-card - Hard/Lunatic
    loop {
+30: // 300
        [...]
+30: // 330
...
The subroutine ``sub144`` lasts for 0f but [hl2]it gets pushed and popped from the stack on the same frame[/hl2]. This means that ``sub144`` cannot exist in the stack, but since it has a return statement [hl2]it can still cause the stack overflow[/hl2] if ``sub144`` happens to be pushed to the 17th slot of the stack. When this happens, Merlin stays around after the boss-fight.
...
So during the final spell-card Merlin glitch, [hl2]there is a ``636/1172`` chance for Merlin to not despawn[/hl2] on Easy/Normal mode. [hl2]Merlin can never not despawn on Hard/Lunatic mode[/hl2] as there is no valid subroutine in the ``call_repeat`` instruction in ``sub142``.


#### Stack overflow - Merlin's post-boss glitch
[hr_minor]

Take the call stack of the [hl2]post-boss Merlin glitch[/hl2].

[box=300]sub71 → [...] → sub143 → [hl2]sub52[/hl2][/box]
...
Sometimes, Merlin still moves around in circles post-boss fight. This can be seen in the replay of the player Ｋ・Ｇ, which is provided in the [jumpto=#links]Links[/jumpto] section.

For this to happen, ``sub137`` [hl2]must be called on the same frame ``sub52`` is called[/hl2]. [hl2]This has a ``1/10`` chance to happen[/hl2] on top of the post-boss Merlin glitch. When this is done, the call stack is as follows:

1. Frame 1: Call stack is ``[...] → sub143``
2. Frame 2: Call stack is ``[...] → sub143 → sub52 → sub137``
4. Also Frame 2: Call stack becomes ``[...] → sub143``
...
Take the call stack of the [hl2]post-boss Lyrica glitch[/hl2].

[box=300]sub88  → [...] → sub152 → [hl2]sub52[/hl2][/box]
...
For this to happen, ``sub137`` [hl2]must be called on the same frame ``sub52`` is called[/hl2]. [hl2]This has a ``1/10`` chance to happen[/hl2] on top of the post-boss Lyrica glitch.

#### Stack overflow - Lunasa's post-boss glitch
[hr_minor]

Take the call stack of the [hl2]post-boss Lunasa glitch[/hl2].

[box=300]sub53  → [...] → sub135 → [hl2]sub52[/hl2][/box]
...
For this to happen, ``sub136`` [hl2]must be called on the same frame ``sub52`` is called[/hl2]. The probabilities for Merlin to circle around post boss-fight on top of the post-boss Lunasa glitch are as follows:
+ On Easy mode: ``1/12``
+ On Normal mode: ``1/8``
+ On Hard mode: ``1/11``
...
The Prismriver sisters' [hl2]boss-fight is implemented differently[/hl2] than how other bosses are implemented. In the case of the Prismriver sisters, they are [hl2]controlled by an invisible boss manager[/hl2]. This is different from other bosses in PCB. In this case, [hl2]the stack of the invisible boss manager gets reset[/hl2] whenever a life/timer callback is triggered. This is not the case with the Prismriver sisters themselves.
...
Easy/Normal mode:
<ol class='toc'>
        <li>Merlin does not glitch out E/N - 41/42</li>
        <li>Merlin does glitch out E/N - 1/42
                <ol>
                        <li>[hl2]Final spell-card Merlin glitch - 1/19 (1/787)[/hl2]
                                <ol>
                                        <li>Merlin does not despawn - 636/1172 (1/1450)</li>
                                        <li>Merlin does despawn - 536/1172 (1/1720)</li>
                                </ol>
                        </li>
                        <li>Post-boss Merlin glitch - 1/1.056 (1/44)
                                <ol>
                                        <li>Merlin does not circle around - 9/10 (1/49)</li>
                                        <li>Merlin does circle around - 1/10 (1/440)</li>
                                </ol>
                        </li>
                </ol>
        </li>
...
Hard/Lunatic mode:
<ol class='toc'>
        <li>Merlin does not glitch out H/L - 44/45</li>
        <li>Merlin does glitch out H/L - 1/45
                <ol>
                        <li>[hl2]Final spell-card Merlin glitch - 1/19 (1/854)[/hl2]</li>
                        <li>Post-boss Merlin glitch - 1/1.056 (1/48)
                                <ol>
                                        <li>Merlin does not circle around - 9/10 (1/53)</li>
                                        <li>Merlin does circle around - 1/10 (1/476)</li>
                                </ol>
                        </li>
                </ol>
        </li>
...
Easy/Normal mode:
<ol class='toc'>
        <li>No post-boss Lyrica glitch - 45102/45103</li>
        <li>[hl2]Post-boss Lyrica glitch E/N - 1/45103[/hl2]
                <ol>
                        <li>Lyrica does not circle around - 9/10 (1/50114)</li>
                        <li>Lyrica does circle around - 1/10 (1/451032)</li>
                </ol>
        </li>
</ol>
...
Hard/Lunatic mode:
<ol class='toc'>
        <li>No post-boss Lyrica glitch H/L - 54306/54307</li>
        <li>[hl2]Post-boss Lyrica glitch H/L - 1/54307[/hl2]
                <ol>
                        <li>Lyrica does not circle around - 9/10 (1/60314)</li>
                        <li>Lyrica does circle around - 1/10 (1/543073)</li>
                </ol>
        </li>
</ol>
...
Easy mode:
<ol class='toc'>
        <li>No post-boss Lunasa glitch - 33542/33543</li>
        <li>[hl2]Post-boss Lunasa glitch E/N - 1/33543[/hl2]
                <ol>
                        <li>Lunasa does not circle around Easy - 11/12 (1/36592)</li>
                        <li>Lunasa does circle around Easy - 1/12 (1/402513)</li>
                </ol>
        </li>
</ol>
...
<ol class='toc'>
        ...
        <li>[hl2]Post-boss Lunasa glitch E/N - 1/33543[/hl2]
                <ol>
                        <li>Lunasa does not circle around Normal - 7/8 (1/38335)</li>
                        <li>Lunasa does circle around Normal - 1/8 (1/268342)</li>
                </ol>
        </li>
</ol>
...
Hard mode:
<ol class='toc'>
        <li>No post-boss Lunasa glitch - 36384/36385</li>
        <li>[hl2]Post-boss Lunasa glitch H/L - 1/36385[/hl2]
                <ol>
                        <li>Lunasa does not circle around Hard - 10/11 (1/40024)</li>
                        <li>Lunasa does circle around Hard - 1/11 (1/400239)</li>
                </ol>
        </li>
</ol>
...
<ol class='toc'>
        ...
        <li>[hl2]Post-boss Lunasa glitch H/L - 1/36385[/hl2]
                <ol>
                        <li>Lunasa does not circle around Lunatic - 9/10 (1/40428)</li>
                        <li>Lunasa does circle around Lunatic - 1/10 (1/363854)</li>
                </ol>
        </li>
</ol>
...
[box=1000] The Merlin/Lyrica/Lunasa glitch is triggered through [hl2]precisely-timed kills on various patterns[/hl2] as Sakuya/Marisa/Reimu respectively. There is roughly a [hl2]1 in 800 chance[/hl2] to get the final spell-card Merlin glitch. For Merlin to glitch out post-boss, there is roughly a lenient [hl2]1 in 32 chance.[/hl2] For Lunasa to glitch out, its probability is roughly a [hl2]1 in 35,000 chance[/hl2]. For Lyrica to glitch out, its probability is roughly a [hl2]1 in 50,000 chance[/hl2].  This has to do with how the game handles the [hl2]call stack[/hl2]. The issue is caused because of [hl2]stack overflow[/hl2]. This causes the sisters to [hl2]prematurely return to their previous attack[/hl2].[/box]
