[title=FW: No Bombs in Practice Mode]
...
[img=bugs/th20/13_zero_bombs.png, figtitle=The bomb display shows no bombs., alt=Screenshot of the GUI]
[img=bugs/th20/13_zero_max_bombs.png, figtitle=There is no bomb display in the GUI., alt=Screenshot of the GUI] 
