[title=Saki's Final Bomb Damage]
...
* **Shottype**: [yes]ReimuWolf[/yes] - [yes]MarisaWolf[/yes] - [yes]YoumuWolf[/yes] - [yes]ReimuOtter[/yes] - [yes]MarisaOtter[/yes] - [yes]YoumuOtter[/yes] - [yes]ReimuEagle[/yes] - [yes]MarisaEagle[/yes] - [yes]YoumuEagle[/yes]
...
[img=bugs/th17/8_hurtbox.png, figtitle=A screenshot Saki having a health bar despite bombing during a spell-card., alt=Screenshot of Youmu bombing on Saki's final]
