...
* **Mode**: [yes]Story mode[/yes] - [yes]Match mode[/yes]
* **Shottype**: All
...
This happens if your operating system's time is after the timestamp 19th of January 2038, 03:14:07 UTC. [hl2]The crash happens when entering a stage[/hl2], whether it is from starting a credit or watching a replay (title screen demo included). Starting a credit before 19th of January 2038, 03:14:07 UTC but entering a new stage during the same credit after 19th of January 2038, 03:14:07 UTC will still yield a crash.
...
(For technical readers, the assembly code can be found at an offset ``0x47c20a`` in 1.50a.)
...
[code]void GetDate(char *buffer)
{
    ...
    _strftime(buffer, 10, "%y/%m/%d", tm_info);
}
[/code]

(For technical readers, the assembly code can be found at an offset ``0x41a796`` in 1.50a.)
