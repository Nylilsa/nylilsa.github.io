...
[img=guides/th17-maingame-score/otter.jpg, figtitle=TITLETOBEADDED, alt=ALTTOBEADDED, other=max-height:360px]
...
[img=guides/th17-maingame-score/Senza-nome.png, figtitle=TITLETOBEADDED, alt=ALTTOBEADDED, other=max-height:360px]
...
**Note**: not all setups are perfectly realistic (same exact tokens) but all come pretty close, or at least as close as possible. most of those strats make use of suicides, make sure that you aren't losing too much [style=power, icon=false, highlightedText=power] and use thprac's Infinite Power cheat if needed.
...
[img=guides/th17-maingame-score/th17_000.jpg, figtitle=TITLETOBEADDED, alt=ALTTOBEADDED, other=max-width:360px]
