...
The variable [ins=2, n=2] in HSiFS changes in the following event:
2. In the main game, Okina depletes to 0 HP or the timer reaches 00.00s outside of Spell practice mode  (``[ins=2, n=2] = 0.5``), lasting for 60 frames.
2. In the main game, Okina explodes after her final spell card outside of Spell practice mode (``[ins=2, n=2] = 0.25``), lasting for 30 frames.
3. In Extra mode, Okina explodes after her final spell card outside of Spell practice mode (``[ins=2, n=2] = 0.25``), lasting for 30 frames.
