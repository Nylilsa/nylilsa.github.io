...
[img=bugs/th10/2_desync.png, hratio=2, other= ]
...
Because there is a height difference of the fairies when they spawn, there are some obvious ways this could desync the replay. They will be classified as either [hl2]obvious[/hl2] causes or [hl2]obscure[/hl2].
