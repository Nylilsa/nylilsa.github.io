...
The variable [ins=2, n=2] in DDC changes in the following event:
1. Shinmyoumaru depletes to 0 HP or the timer reaches 00.00s outside of Spell practice mode (``[ins=2, n=2] = 0.5``), lasting for 60 frames.
2. Shinmyoumaru explodes after her final spell card outside of Spell practice mode (``[ins=2, n=2] = 0.25``), lasting for 30 frames.
3. Raiko depletes to 0 HP or the timer reaches 00.00s outside of Spell practice mode (``[ins=2, n=2] = 0.5``), lasting for 60 frames.
4. Raiko explodes after her final spell card outside of Spell practice mode (``[ins=2, n=2] = 0.25``), lasting for 30 frames.
