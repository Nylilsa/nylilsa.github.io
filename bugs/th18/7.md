...
[img=bugs/th18/7_spam.png, figtitle=Marisa is being overwhelmed by Momoyo's attack Dragon Eater., alt=Momoyo overwhelming the player with bullets, other= ] [br]
...
[img=bugs/th18/7_angle.png, figtitle=Visualisation of the precise angle is shown in pink., alt=Two lines spawn out of Momoyo pointing to the bottom right., other= ] [br]
