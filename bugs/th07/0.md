...
Table of contents
        ...
        <li>[jumpto=#/bugs/th07/0#whyithappens][why][/jumpto]
                <ol>
                        ...
                        <li>[jumpto=#/bugs/th07/0#stackoverflow]Stack overflow[/jumpto]
                                <ol>
                                        <li>[jumpto=#/bugs/th07/0#stackoverflowmerlinsfinalspellcardglitch]Stack overflow - Merlin's final spell-card glitch[/jumpto]
                                                <ol>
                                                        <li>[jumpto=#/bugs/th07/0#merlinsfinalspellcardglitchmerlindoesnotdespawn]Merlin's final spell-card glitch - Merlin does not despawn[/jumpto]</li>
                                                </ol>
                                        </li>
                                        <li>[jumpto=#/bugs/th07/0#stackoverflowmerlinspostbossglitch]Stack overflow - Merlin's post-boss glitch[/jumpto]
                                                <ol>
                                                        <li>[jumpto=#/bugs/th07/0#merlinspostbossglitchcircularmotion]Merlin's post-boss glitch - Circular motion[/jumpto]</li>
                                                </ol>
                                        </li>
                                        <li>[jumpto=#/bugs/th07/0#stackoverflowlyricaspostbossglitch]Stack overflow - Lyrica's post-boss glitch[/jumpto]
                                                <ol>
                                                        <li>[jumpto=#/bugs/th07/0#lyricaspostbossglitchcircularmotion]Lyrica's post-boss glitch - Circular motion[/jumpto]</li>
                                                </ol>
                                        </li>
                                        <li>[jumpto=#/bugs/th07/0#stackoverflowlunasaspostbossglitch]Stack overflow - Lunasa's post-boss glitch[/jumpto]
                                                <ol>
                                                        <li>[jumpto=#/bugs/th07/0#lunasaspostbossglitchcircularmotion]Lunasa's post-boss glitch - Circular motion[/jumpto]</li>
                                                </ol>
                                        </li>
                                </ol>
                        </li>
        ...
        <li>[jumpto=#/bugs/th07/0#allprobabilities]All probabilities[/jumpto]
                <ol>
                        <li>[jumpto=#/bugs/th07/0#merlinsprobabilities]Merlin's probabilities[/jumpto]</li>
                        <li>[jumpto=#/bugs/th07/0#lyricasprobabilities]Lyrica's probabilities[/jumpto]</li>
                        <li>[jumpto=#/bugs/th07/0#lunasasprobabilities]Lunasa's probabilities[/jumpto]</li>
                </ol>
        </li>
        <li>[jumpto=#/bugs/th07/0#conclusion]Conclusion[/jumpto]</li>
        <li>[jumpto=#/bugs/th07/0#links][links][/jumpto]
            <ol>
                <li>[jumpto=#/bugs/th07/0#replays][rpy][/jumpto]</li>
                <li>[jumpto=#/bugs/th07/0#videos][vid][/jumpto]</li>
                <li>[jumpto=#/bugs/th07/0#other][misc][/jumpto]</li>
            </ol>
        </li>
</ol>
...
[img=bugs/th07/0_merlin.png, figtitle=Two instances in which Merlin glitches out on the final spell-card., alt=Two images of Merlin glitching out] [br]
...
[img=bugs/th07/0_lyrica_lunasa.png, figtitle=Lyrica and Lunasa both glitch out after the final spell-card, alt=Two images of Lunasa and Lyrica glitching out] [br]
...
Note: The precisely-timed kills thing only works on the Prismriver sisters ! It does not work on other PCB bosses. The reason is explained [jumpto=#/bugs/th07/0#stackoverflowonotherbosses]here[/jumpto].
...
Sometimes, Merlin still moves around in circles post-boss fight. This can be seen in the replay of the player Ｋ・Ｇ, which is provided in the [jumpto=#/bugs/th07/0#links]Links[/jumpto] section.
