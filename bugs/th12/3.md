[title=UFO: Slowdown Item Duplication]
...
The variable [ins=2, n=2] in UFO changes in the following events:
1. Byakuren depletes to 0 HP or the timer reaches 00.00s on her final spell-card (``[ins=2, n=2] = 0.5``), lasting for 60 frames.
2. Byakuren explodes after her final spell-card (``[ins=2, n=2] = 0.25``), lasting for 30 frames.
3. Nue depletes to 0 HP or the timer reaches 00.00s on her final spell-card (``[ins=2, n=2] = 0.5``), lasting for 60 frames.
4. Nue explodes after her final spell-card (``[ins=2, n=2] = 0.25``), lasting for 30 frames.
