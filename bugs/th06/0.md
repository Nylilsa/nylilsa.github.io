...
During a bossfight the player can from one boss attack to another boss attack through different ways. Those different ways are by [hl2]attacking[/hl2] or by [hl2]timing out[/hl2] the pattern. In either case, the boss calls for a [hl2]callback function[/hl2].
...
Below is a real example of the code of Rumia's first non-spell and Rumia's first spell-card. Any code that doesn't contain the three above mentioned functions is removed.
